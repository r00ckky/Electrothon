...
class CommunWidget extends StatefulWidget {
  const CommunWidget({Key key}) : super(key: key);

  @override
  _CommunWidgetState createState() => _CommunWidgetState();
}

class _CommunWidgetState extends State<CommunWidget> {
